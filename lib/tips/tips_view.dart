...
import 'package:workout_fitness/common_widget/top_row.dart';
import 'package:workout_fitness/tips/tips_detail_view.dart';
...
class TipsView extends StatefulWidget {
  ...
  @override
  State<TipsView> createState() => _WeightViewState();
}

class _WeightViewState extends State<TipsView> {
  List tipsArr = [
    {"name": "About Training"},
